...
const HeroSection = () => {
  ...
  return (
    <section ref={ref} className="relative min-h-screen w-full overflow-hidden bg-foreground">
      ...
      >
        <img src={brandLogo} alt="Akshaya Medicals logo" className="h-14 w-14 rounded-full drop-shadow-lg sm:hidden" />
        <img src={brandLogo} alt="Akshaya Medicals logo" className="hidden h-20 w-20 rounded-full drop-shadow-lg sm:block" />
      </motion.div>
